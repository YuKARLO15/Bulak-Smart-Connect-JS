...
const DashboardButtons = () => {
    return (
        ...
        <Box className="IconsSection">
           <RouterLink to = '/ApplicationForm'>   <Button className="IconButton">
             <img src={ApplicationBtn} alt="Application" /> Document Application 
            </Button></RouterLink>  
            <RouterLink to = '/QR'>  <Button className="IconButton">
                <img src= {WalkInBtn} alt="Walk-In Number" /> Walk-In Number
            </Button> </RouterLink>
            <RouterLink> <Button className="IconButton">
                <img src={Requirments} alt="QR-Code Scanner" /> Requirment List
            </Button> </RouterLink>
            <RouterLink to = '/AppointmentForm'>    <Button className="IconButton">

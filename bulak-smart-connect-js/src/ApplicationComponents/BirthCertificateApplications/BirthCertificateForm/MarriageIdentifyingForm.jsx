        ...
        <>
          ...
          <Box className="MarriageFormContent">
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Typography className="MarriageFormSubtitle">
                  20.a DATE {requiredField}
                </Typography>
              </Grid>
          ...
          <Box className="MarriageFormNote" mt={2}>
            <Alert severity="info">
              NOTE: After submitting the documents online, all required documents for this field must also be submitted to the Office of the Civil Registrar.
            </Alert>
          </Box>
        </>
      )}

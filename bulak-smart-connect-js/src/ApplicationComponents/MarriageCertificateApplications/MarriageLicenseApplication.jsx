...
import { Box, Button, Checkbox, FormControlLabel, Typography, Alert, Radio, RadioGroup, FormControl } from "@mui/material";
...
const MarriageLicenseApplication = () => {
  ...
  return (
      ...
      <Typography variant="h5" className="TitleMarriageLicense">MARRIAGE CERTIFICATE APPLICATION</Typography>
      ...
      <Box className="ApplicantTypeSectionMarriageLicense">
        <FormControlLabel
          control={<Checkbox checked={foreignNational} onChange={() => setForeignNational(!foreignNational)} />}
          label="Foreign National"
        />
        <FormControlLabel
          control={<Checkbox checked={widowWidower} onChange={() => setWidowWidower(!widowWidower)} />}
          label="Widow / Widower"
        />
        <FormControlLabel
      ...
      <Box className="MandatoryDocumentsMarriageLicense">
        <Typography variant="body1" className="SectionTitleMarriageLicense">Mandatory Documents:</Typography>
      ...
      {foreignNational && (
        <Box className="AdditionalDocumentsMarriageLicense">
          ...
          <FileUpload label="Legal Capacity from their embassy (Manila)" onUpload={handleFileUpload} />
      ...
      {widowWidower && (
        <Box className="AdditionalDocumentsMarriageLicense">
          <Typography variant="body1" className="SectionTitleMarriageLicense">For Widow / Widower:</Typography>
          ...
          <FileUpload label="Registered Death Certificate of Previous Spouse" onUpload={handleFileUpload} />
        </Box>
      )}
      ...
      {annulled && (
        <Box className="AdditionalDocumentsMarriageLicense">
          <Typography variant="body1" className="SectionTitleMarriageLicense">For Annulled Applicants:</Typography>
          ...
          <FormControl className="RadioGroupMarriageLicense">
            ...
            <RadioGroup
              row
              value={annulledType}
              onChange={(e) => setAnnulledType(e.target.value)}
            >
              <FormControlLabel value="Groom" control={<Radio />} label="Groom" />
              <FormControlLabel value="Bride" control={<Radio />} label="Bride" />
            </RadioGroup>
          ...
          <FileUpload label="Decree of Annulment from Court with FINALITY" onUpload={handleFileUpload} />
        </Box>
      )}

...
const AdminBirthAffidavitPreviewPage = ({ applicationId, currentUser }) => {
  ...
  const canView = currentUser?.role === 'super admin' || currentUser?.role === 'admin';

  // Format current date and time in UTC with the specified format
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Combine form data from both sources to ensure we have all fields
        ...
        // Set specific affidavit fields from the application data
            ...
            <div className="FormRowAffidavit">
              <div className="AffidavitText">
                ...
                <span className="MaritalStatusOptions">
                  <span className="CheckboxContainerAffidavit MaritalStatusCheckbox">
                    <input
                      ...
                      onChange={() => isEditMode && handleMaritalStatusChange('single')}
                  ...
                  <span className="CheckboxContainerAffidavit MaritalStatusCheckbox">
                    <input
                      ...
                      onChange={() => isEditMode && handleMaritalStatusChange('married')}
                      className="CheckboxInputAffidavit"
                      disabled={!isEditMode}
                    />
                  ...
                  <span className="CheckboxContainerAffidavit MaritalStatusCheckbox">
                    <input
                      ...
                      onChange={() => isEditMode && handleMaritalStatusChange('divorced')}
                      className="CheckboxInputAffidavit"
                      disabled={!isEditMode}
                    />
                  ...
                  <span className="CheckboxContainerAffidavit MaritalStatusCheckbox">
                    <input
                      ...
                      onChange={() => isEditMode && handleMaritalStatusChange('widow')}
                      className="CheckboxInputAffidavit"
                      disabled={!isEditMode}
                    />
                  ...
                  <span className="CheckboxContainerAffidavit MaritalStatusCheckbox">
                    <input
                      ...
                      onChange={() => isEditMode && handleMaritalStatusChange('widower')}
                      className="CheckboxInputAffidavit"
                      disabled={!isEditMode}
                    />
                ...
                {isEditMode ? (
                  ...
                  <span className="AffidavitUnderlineInput ReadOnly">
                    {formData?.delayedAffiantAddress || ''}
                  </span>
                )}
            ...
            <div className="FormRowAffidavit">
              <div className="AffidavitText">
                ...
                {isEditMode ? (
                  ...
                  <span className="AffidavitUnderlineInput ReadOnly">
                    {formData?.citizenship || formData?.motherCitizenship || ''}
                  </span>
                )}
                .
              </div>

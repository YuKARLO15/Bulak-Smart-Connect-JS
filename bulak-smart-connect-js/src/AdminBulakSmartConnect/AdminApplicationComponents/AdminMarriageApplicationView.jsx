    ...
    <Box className="MarriageCertificateContainerAdmin">
      ...
      <Grid container className="DetailsGridAdmin">
        <Grid item xs={8} className="LocationContainerAdmin">
          <Grid container>
            <Grid item xs={12} className="ProvinceFieldAdmin">
              <Typography variant="body2" className="DetailsLabelAdmin">Province</Typography>
            ...
            <Grid item xs={12} className="CityFieldAdmin">
              <Typography variant="body2" className="DetailsLabelAdmin">City/Municipality</Typography>
              <Typography variant="body1" className="DetailsValueAdmin">
        ...
        <Grid item xs={4} className="RegistryContainerAdmin">
          <Typography variant="body2" className="DetailsLabelAdmin">Registry No.</Typography>
          <Typography variant="body1" className="DetailsValueAdmin">_____________</Typography>
        </Grid>
      </Grid>
      ...
      <Grid container className="MainSectionAdmin">
        ...
        <Grid item xs={6} className="HusbandHeaderAdmin">
          <Typography variant="subtitle1" className="HeaderTextAdmin">HUSBAND</Typography>
        </Grid>
        <Grid item xs={6} className="WifeHeaderAdmin">
          <Typography variant="subtitle1" className="HeaderTextAdmin">WIFE</Typography>
        </Grid>
    
        <Grid item xs={12} className="NameSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">1. Name of Contracting Parties</Typography>
            </Grid>
            ...
            <Grid item xs={6} className="HusbandNameContainerAdmin">
              <Grid container>
                <Grid item xs={12} className="FirstNameFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(First)</Typography>
                ...
                <Grid item xs={12} className="MiddleNameFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Middle)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
                    {formData.husbandMiddleName || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={12} className="LastNameFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Last)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
        ...
        <Grid item xs={12} className="BirthDateSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">2a. Date of Birth</Typography>
            </Grid>
      
            <Grid item xs={6} className="HusbandBirthDateContainerAdmin">
              <Grid container>
                <Grid item xs={4} className="DayFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Day)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
                    {formData.husbandBirthDay || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={4} className="MonthFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Month)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
                    {formData.husbandBirthMonth || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={4} className="YearFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Year)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
          ...
          <Grid container className="AgeSectionAdmin">
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">2b. Age</Typography>
            </Grid>
        ...
        <Grid item xs={12} className="BirthPlaceSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">3. Place of Birth</Typography>
            </Grid>
            ...
            <Grid item xs={6} className="HusbandBirthPlaceContainerAdmin">
              <Grid container>
                <Grid item xs={4} className="CityFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(City/Municipality)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
                    {formData.husbandBirthCity || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={4} className="ProvinceFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Province)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
                    {formData.husbandBirthProvince || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={4} className="CountryFieldAdmin">
                  <Typography variant="caption" className="FieldLabelAdmin">(Country)</Typography>
                  <Typography variant="body1" className="FieldValueAdmin">
        ...
        <Grid item xs={12} className="SexCitizenshipSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">4a. Sex</Typography>
            </Grid>
          ...
          <Grid container className="CitizenshipSectionAdmin">
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">4b. Citizenship</Typography>
            </Grid>
        ...
        <Grid item xs={12} className="ResidenceSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">5. Residence</Typography>
              <Typography variant="caption" className="FieldLabelAdmin">(House No., St., Barangay, City/Municipality, Province, Country)</Typography>
            </Grid>
        ...
        <Grid item xs={12} className="ReligionSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">6. Religion/Religious Sect</Typography>
            </Grid>
        ...
        <Grid item xs={12} className="CivilStatusSectionAdmin">
          <Grid container>
            <Grid item xs={12} className="SectionTitleRowAdmin">
              <Typography variant="body2" className="SectionTitleTextAdmin">7. Civil Status</Typography>
            </Grid>
      ...
      <Grid container className="MarriageDetailsSectionAdmin">
        ...
        <Grid item xs={12} className="MarriagePlaceSectionAdmin">
          <Typography variant="body2" className="SectionTitleTextAdmin">15. Place of Marriage:</Typography>
          <Grid container>
            <Grid item xs={4} className="MarriageOfficeFieldAdmin">
              <Typography variant="caption" className="FieldLabelAdmin">(Office/House of/Barangay of/Church of/Mosque of)</Typography>
              <Typography variant="body1" className="FieldValueAdmin">
        ...
        <Grid item xs={12} className="MarriageDateSectionAdmin">
          <Typography variant="body2" className="SectionTitleTextAdmin">16. Date of Marriage:</Typography>
          <Grid container>
        ...
        <Grid item xs={12} className="MarriageTimeSectionAdmin">
          <Typography variant="body2" className="SectionTitleTextAdmin">17. Time of Marriage:</Typography>
          <Typography variant="body1" className="FieldValueAdmin">
      ...
      <Grid container className="WitnessesSectionAdmin">
        ...
        <Grid item xs={6} className="Witness1ContainerAdmin">
          <Typography variant="body2" className="SectionTitleTextAdmin">Witness 1:</Typography>
          <Typography variant="body1" className="FieldValueAdmin">
            {formatName(formData.witness1FirstName, "", formData.witness1LastName)}
          </Typography>
          <Typography variant="caption" className="FieldLabelAdmin">Address:</Typography>
          <Typography variant="body1" className="FieldValueAdmin">
        ...
        <Grid item xs={6} className="Witness2ContainerAdmin">
          <Typography variant="body2" className="SectionTitleTextAdmin">Witness 2:</Typography>
          <Typography variant="body1" className="FieldValueAdmin">

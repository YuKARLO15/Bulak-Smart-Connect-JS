            ...
            <Grid item xs={12} md={9}>
              <Card className="AboutCardLanding">
                <CardContent>
                  ...
                  >
                    Skip the long lines and handle your municipal transactions with ease!
                    Bulak LGU Smart Connect is the official queuing
                     and information system of the Municipal Civil Registrar of San Ildefonso,
                     Bulacan. Secure your queue number online, track real-time queue number, schedule appointments,
                    and submit documents for birth, marriage, and death certificates all from your phone or computer.
                    Get real-time updates and enjoy a hassle-free, efficient government service.
                    Your time matters make every visit smooth and stress-free!
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
              ...
              <Grid item xs={12} md={9}>
                <Box className="FeatureContentLanding">
                  ...
                  >
                                      ...
                                      certificate applications, eliminating the need for long waits.
                  </Typography>
                </Box>
              </Grid>
            </Grid>
              ...
              <Grid item xs={12} md={9}>
                <Box className="FeatureContentLanding">
                  ...
                  >
                    ...
                    Submit your birth, marriage, or death certificate application online,
                    upload the required documents, and track your request in real time.
                    Get notified once your application is processed and ready for pickup
                    no more unnecessary visits or long waits. Convenient, efficient, and hassle-free!
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={3}>
              ...
              <Grid item xs={12} md={9}>
                <Box className="FeatureContentLanding">
                  ...
                  <Typography
                    ...
                    className="FeatureDescriptionLanding"
                  >
                    Fast-track your transaction with QR scanning! Municipal staff will scan your QR
                    code to quickly retrieve your queue number, appointment details, or document
                    application status. This ensures faster processing, reduces wait times, and
                    provides a smooth and efficient experience at the Municipal Civil Registrar of San Ildefonso Bulacan
                  </Typography>
                </Box>
              </Grid>
            </Grid>

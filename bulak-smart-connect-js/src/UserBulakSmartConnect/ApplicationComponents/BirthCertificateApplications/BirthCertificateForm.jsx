      ...
      if (isEditing && editingApplicationId) {
        try {
          const originalApplication =
            await documentApplicationService.getApplication(editingApplicationId);
          const originalSubtype =
            originalApplication.applicationSubtype ||
        ...
        routeOption =
          sessionStorage.getItem('selectedBirthCertificateOption') || 'Regular application';
      }
        ...
        {step === 1 && (
          <>
            ...
            <Box className="FormProgressContainer">
              <Typography variant="body2">Step {step} of 5</Typography>

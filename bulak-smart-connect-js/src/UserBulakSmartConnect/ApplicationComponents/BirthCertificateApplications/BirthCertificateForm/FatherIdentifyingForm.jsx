      ...
      if (!isValid) {
        ...
        setTimeout(() => {
          ...
          const firstErrorElement = document.querySelector(
            '.FatherAcknowledgmentFormControl.Mui-error, .FormInputFather.error, .SelectInputFather.error'
          );
      ...
      {formData?.fatherAcknowledgment === 'acknowledged' && (
        <div className="FormContentFather">
          ...
          <div className="FormSectionFather">
            <div className="SectionTitleFather">14. FULL NAME (Buong Pangalan) {requiredField}</div>

            <div className="FormRowFather">
              <div className="FormGroupFather">
                <label className="FormLabelFather">First Name (Pangalan) {requiredField}</label>
                <input
                  type="text"
                ...
                {errors.fatherFirstName && (
                  <span className="ErrorMessageFather">{errors.fatherFirstName}</span>
                )}
              </div>
              ...
              <div className="FormGroupFather">
                <label className="FormLabelFather">Last Name (Apelyido) {requiredField}</label>
                <input
                  type="text"
                  name="fatherLastName"
                ...
                {errors.fatherLastName && (
                  <span className="ErrorMessageFather">{errors.fatherLastName}</span>
                )}
              </div>
            </div>
          ...
          <div className="FormSectionFather">
            <div className="FormRowFather">
              <div className="FormGroupFather" style={{ flex: 1 }}>
                <div className="SectionTitleHalfFather">15. CITIZENSHIP {requiredField}</div>
                <input
                  type="text"
                ...
                {errors.fatherCitizenship && (
                  <span className="ErrorMessageFather">{errors.fatherCitizenship}</span>
                )}
              </div>
              ...
              <div className="FormGroupFather" style={{ flex: 1 }}>
                ...
                {errors.fatherReligion && (
                  <span className="ErrorMessageFather">{errors.fatherReligion}</span>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="FormSectionFather">
            <div className="FormRowFather">
              <div className="FormGroupFather" style={{ flex: 1 }}>
                <div className="SectionTitleHalfFather">17. OCCUPATION {requiredField}</div>
                <input
                  type="text"
                ...
                {errors.fatherOccupation && (
                  <span className="ErrorMessageFather">{errors.fatherOccupation}</span>
                )}
              </div>
          ...
          {/* Residence Section */}
          <div className="FormSectionFather">
            <div className="SectionTitleFather">19. RESIDENCE {requiredField}</div>

            <div className="FormRowFather">
              <div className="FormGroupFather">
                <label className="FormLabelFather">House NO., Street {requiredField}</label>
                <input
                  type="text"
                  name="fatherStreet"
                ...
                />
                {errors.fatherStreet && (
                  <span className="ErrorMessageFather">{errors.fatherStreet}</span>
                )}
              </div>

              <div className="FormGroupFather">
                <label className="FormLabelFather">Barangay {requiredField}</label>
                <input
                  type="text"
                  name="fatherBarangay"
                  ...
                  required
                />
                {errors.fatherBarangay && (
                  <span className="ErrorMessageFather">{errors.fatherBarangay}</span>
                )}
              </div>
            </div>
            ...
            <div className="FormRowFather">
              <div className="FormGroupFather">
                <label className="FormLabelFather">City/Municipality {requiredField}</label>
                <input
                  type="text"
                  name="fatherCity"
                ...
                />
                {errors.fatherCity && (
                  <span className="ErrorMessageFather">{errors.fatherCity}</span>
                )}
              </div>

              <div className="FormGroupFather">
                <label className="FormLabelFather">Province {requiredField}</label>
                <input
                  type="text"
                  name="fatherProvince"
                  ...
                  required
                />
                {errors.fatherProvince && (
                  <span className="ErrorMessageFather">{errors.fatherProvince}</span>
                )}
              </div>
            </div>
            ...
            <div className="FormRowFather">
              <div className="FormGroupFather">
                <label className="FormLabelFather">Country {requiredField}</label>
                <input
                  type="text"
                  name="fatherCountry"
                  ...
                  required
                />
                {errors.fatherCountry && (
                  <span className="ErrorMessageFather">{errors.fatherCountry}</span>
                )}
              </div>
            </div>
          </div>

    ...
    <Document>
      <Page size="LEGAL" style={styles.page}>
        ...
        <View style={styles.overlay}>
          ...
          <Text style={styles.birthWeight}>
            {formData?.birthWeight ? `${formData.birthWeight} grams` : ''}
          </Text>
          ...
          <Text style={styles.motherDeceasedChildren}>
            {formData?.motherDeceasedChildren || ''}
          </Text>
          ...
          <Text style={styles.certificationDate}>
            {formatDate(
              formData?.certificationMonth,
              formData?.certificationDay,
              formData?.certificationYear
            )}
          </Text>

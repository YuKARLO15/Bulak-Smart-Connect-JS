    ...
    <div className="page-container">
      <div className="privacy-container">
          ...
          <div className="english-content">
            <div id="terms-and-conditions">
              <p>
                ...
                in the Philippines governing the processing of personal information in both
              ...
              <p>
                This service integrates a web application for submitting requests. After
                successfully submitting a document request through the website, the user will be
                notified and required to proceed to the Municipal Civil Registrar Office of San
                Ildefonso to complete the transaction by paying the corresponding fees and claiming
              ...
              <p>
                ...
                handled in accordance with the Data Privacy Act of 2012. These documents are
                securely stored and will only be accessed by authorized personnel for processing
                purposes.
              </p>
              ...
              <p>
                All personal and sensitive information provided, including any required documents
                submitted for the application of the Certificate of Marriage, is protected and
                handled in accordance with the Data Privacy Act of 2012. These documents are
                securely stored and will only be accessed by authorized personnel for processing
                purposes.
              </p>
              ...
              <p>
                All personal and sensitive information provided, including any required documents
                submitted for the application of the Fetal Death Certificate, is protected and
                handled in accordance with the Data Privacy Act of 2012. These documents are
                securely stored and will only be accessed by authorized personnel for processing
                purposes.
              </p>
              ...
              <p>
                ...
                accordance with the Data Privacy Act of 2012. These documents are securely stored
              ...
              <p>
                The <strong>Municipal Civil Registrar Office of San Ildefonso</strong>, as a
                personal information controller, will use the collected data solely to validate and
                process requests for civil registry documents. All data is necessary for request
                validation. Incomplete or inaccurate information may result in rejection or delay.
              </p>
              <p>
              ...
              <p>
                Collected data is stored in a secured, password-protected database with encryption
                and firewall protection. When transmitted, data is securely sent to the appropriate
              ...
              <h2>Method of Use</h2>
              <p>
                Personal Data is used strictly to process requests for civil registry documents.
                Data will not be used for marketing or other unrelated purposes. All processing is
                done according to government-approved information security standards.
              </p>
              ...
              <p>
                Personal data will be retained only as long as needed to fulfill its intended
                purpose or comply with legal requirements. Once retention is no longer necessary,
            ...
            <div id="terms-and-conditions">
              ...
              <p>
                ...
                accessing or using this website and services, you agree to comply with and be bound
                by these Terms.
              </p>
              ...
              <h2>2. Eligibility</h2>
              <p>
                You must be a qualified user as determined by the{' '}
              ...
              <ul>
                <li>
                  ...
                  are required to visit the <strong>Municipal Civil Registrar Office</strong> to pay
                  the applicable fees and claim your requested documents.
                </li>
                <li>
                  The <strong>Municipal Civil Registrar Office</strong> reserves the right to refuse
                  any requests if payments are not completed or if the documents are not claimed
              ...
              <p>
                ...
                property of the <strong>Municipal Civil Registrar Office of San Ildefonso</strong>{' '}
                or its licensors and are protected by applicable intellectual property laws. You may
                not copy, reproduce, distribute, or create derivative works without prior written
                permission.
              </p>
              ...
              <ul>
                <li>
                  The <strong>Municipal Civil Registrar Office</strong> makes no guarantees about
                  the accuracy, reliability, or availability of the services.
                </li>
                <li>
        ...
        {isTagalog && (
          <div className="tagalog-content">
            <div id="terms-and-conditions">
              ...
              <p>
                Ang serbisyong ito ay pinagsasama ang isang web application para sa pagsusumite ng
                mga kahilingan. Pagkatapos ng matagumpay na pagsusumite ng kahilingan sa dokumento
                sa website, ang user ay aabisuhan at kakailanganing pumunta sa Municipal Civil
                Registrar Office ng San Ildefonso upang makumpleto ang transaksyon sa pamamagitan ng
                pagbabayad ng mga kaugnay na bayad at pagkuha ng hinihinging dokumento.
              </p>
              ...
              <p>
                ...
                Marriage, ay protektado at hinahawakan alinsunod sa Data Privacy Act ng 2012. Ang
              ...
              <p>
                ...
                ang online application form. Lahat ng data ay naka-encrypt at ginagamit lamang para
                sa pagproseso ng dokumento. Hindi ito ginagamit para sa ibang layunin.
              </p>
              ...
              <p>
                ...
                data ay kinakailangan para sa pagpapatunay ng kahilingan. Ang hindi kumpletong o
                hindi tumpak na impormasyon ay maaaring magresulta sa pagtanggi o pagkaantala.
              </p>
              <p>
                Ang tanggapan ay may karapatang magtago ng inyong personal na data kapag
                kinakailangan ng batas at tatanggalin ito kapag hindi na naaangkop ang mga legal na
                kinakailangan.
              </p>
              ...
              <p>
                ...
                Tanging mga awtorisadong tauhan lamang ang maaaring mag-access sa impormasyon na
                ito.
              </p>

              <h2>Paraan ng Paggamit</h2>
              <p>
                Ang Personal na Data ay ginagamit nang mahigpit upang iproseso ang mga kahilingan
                para sa civil registry documents. Ang data ay hindi gagamitin para sa marketing o
                iba pang hindi kaugnay na layunin. Lahat ng pagproseso ay ginagawa ayon sa mga
                pamantayan ng information security na inaprubahan ng gobyerno.
              </p>
              ...
              <p>
                Mayroon kayong karapatan na ma-access, itama, o limitahan ang inyong personal na
                data. Kung naniniwala kayo na ang inyong mga karapatan sa ilalim ng Data Privacy Act
                ay nalabag, maaari kayong makipag-ugnayan sa amin sa pamamagitan ng email sa
            ...
            <div id="terms-and-conditions">
              ...
              <p>
                Dapat ikaw ay kwalipikadong gumagamit ayon sa itinakda ng Tanggapan ng{' '}
                <strong>Municipal Civil Registrar</strong> upang makapag-request ng mga dokumentong
                sibil sa platapormang ito. Sa paggamit ng serbisyo, pinatutunayan mong ikaw ay
                kwalipikado.
              </p>
              ...
              <ul>
                <li>
                  ...
                  transaksyon. Kailangan mong bumisita sa Tanggapan ng{' '}
              ...
              <p>
                ...
                ito ay pag-aari ng Tanggapan ng{' '}
                <strong>Municipal Civil Registrar ng San Ildefonso</strong> o mga tagapaglisensya
                nito at protektado ng batas. Ipinagbabawal ang pagkopya o pamamahagi nang walang
                pahintulot.
              </p>
        ...
        <div className="proceed-button-container">
          ...
          >
            {isTagalog ? 'Sumasangayon at Magpatuloy' : 'I Agree and Proceed'}
          </button>
        </div>
      </div>
    </div>

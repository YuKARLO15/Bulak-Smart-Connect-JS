...
CREATE TABLE `counters` (
  ...
  CONSTRAINT `fk_current_queue` FOREIGN KEY (`current_queue_id`) REFERENCES `queues` (`id`) ON DELETE SET NULL
...
INSERT INTO `users` VALUES (3,'test@example.com','test','$2b$10$iIou9eUq7VHJEloIyItGJOrt9B6ykW6h5ZGuGTjzyFHE9ZT41i7Qm','Test',NULL,'User','Test User','2025-04-14 20:56:08.248933',4),(5,'meee@meee.com','meee','$2b$10$KB62CK3vioFk5so8k56EqO0Sl1Q0V8mQxGUieWvzt2947pprP2bnm','Karlo Robert',NULL,'Wagan','Karlo Robert Wagan','2025-04-14 20:56:08.248933',4),(6,'admin@example.com','admin','$2b$10$oFpTU0U73YZPA.szNm2UHe22GtJY6k3yrGi2qa3txYzOD7EG2h.hq','Admin',NULL,'User','Admin User','2025-04-15 21:09:29.718738',2),(7,'superadmin@example.com','superadmin','$2b$10$oFpTU0U73YZPA.szNm2UHe22GtJY6k3yrGi2qa3txYzOD7EG2h.hq','Super',NULL,'User','Super Admin User','2025-04-15 21:09:29.724504',1),(8,'staff@example.com','staff','$2b$10$oFpTU0U73YZPA.szNm2UHe22GtJY6k3yrGi2qa3txYzOD7EG2h.hq','Staff',NULL,'User','Staff User','2025-04-15 21:09:29.729303',3);
...
-- Dump completed on 2025-05-08 21:45:18
